...
st.header("Movies Recommendation System Using Machine Learning- by Hassii")
...
if st.button('Show Recommendation'):
    ...
    for col, name, poster in zip(cols, recommended_movies_name, recommended_movies_poster):
        with col:
            ...
            # SHA256:DBOLRUfEgtx6tsow8hw0bHi69MVlTq6/rmjJBExrLa8 haseebullahkehar123@gmail.com
